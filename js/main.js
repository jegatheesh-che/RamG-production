...
function startWebsiteEntrance() {
  ...
  if (splitHeroPin) {
    ...
    // Initial entrance of panel text
    splitTl.from('.split-panel-left .split-title', {
        x: -100,
        opacity: 0,
        duration: 1.5,
        ease: "power4.out",
    ...
    .from('.split-panel-right .split-title', {
        x: 100,
        opacity: 0,
        duration: 1.5,
        ease: "power4.out"
    ...
    ScrollTrigger.create({
        ...
        onUpdate: (self) => {
            ...
            if (self.progress > maxProgress) {
                ...
                gsap.to(revealAnim, { progress: maxProgress, duration: 0.5, overwrite: "auto" });
            }
